...
namespace DotPostHog.Api
{
    ...
    /// </summary>
    public interface IWarehouseViewLinkApiSync : IApiAccessor
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns></returns>
        void WarehouseViewLinkDestroy(Guid id, string projectId, int operationIndex = 0);
        ...
        ApiResponse<Object> WarehouseViewLinkDestroyWithHttpInfo(Guid id, string projectId, int operationIndex = 0);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IWarehouseViewLinkApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task WarehouseViewLinkDestroyAsync(Guid id, string projectId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> WarehouseViewLinkDestroyWithHttpInfoAsync(Guid id, string projectId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IWarehouseViewLinkApi : IWarehouseViewLinkApiSync, IWarehouseViewLinkApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class WarehouseViewLinkApi : IWarehouseViewLinkApi
    {
        private DotPostHog.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="WarehouseViewLinkApi"/> class.
        /// </summary>
        /// <returns></returns>
        public WarehouseViewLinkApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public WarehouseViewLinkApi(string basePath)
        {
        ...
        /// <returns></returns>
        public WarehouseViewLinkApi(DotPostHog.Client.Configuration configuration)
        {
        ...
        public WarehouseViewLinkApi(DotPostHog.Client.ISynchronousClient client, DotPostHog.Client.IAsynchronousClient asyncClient, DotPostHog.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns></returns>
        public void WarehouseViewLinkDestroy(Guid id, string projectId, int operationIndex = 0)
        {
            WarehouseViewLinkDestroyWithHttpInfo(id, projectId);
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public DotPostHog.Client.ApiResponse<Object> WarehouseViewLinkDestroyWithHttpInfo(Guid id, string projectId, int operationIndex = 0)
        {
            // verify the required parameter 'projectId' is set
            if (projectId == null)
            {
                throw new DotPostHog.Client.ApiException(400, "Missing required parameter 'projectId' when calling WarehouseViewLinkApi->WarehouseViewLinkDestroy");
            }
            ...
            localVarRequestOptions.Operation = "WarehouseViewLinkApi.WarehouseViewLinkDestroy";
            localVarRequestOptions.OperationIndex = operationIndex;


            // make the HTTP request
            var localVarResponse = this.Client.Delete<Object>("/api/projects/{project_id}/warehouse_view_link/{id}/", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("WarehouseViewLinkDestroy", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task WarehouseViewLinkDestroyAsync(Guid id, string projectId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            await WarehouseViewLinkDestroyWithHttpInfoAsync(id, projectId, operationIndex, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<DotPostHog.Client.ApiResponse<Object>> WarehouseViewLinkDestroyWithHttpInfoAsync(Guid id, string projectId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'projectId' is set
            if (projectId == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.DeleteAsync<Object>("/api/projects/{project_id}/warehouse_view_link/{id}/", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public DotPostHog.Client.ApiResponse<PostHogPaginatedViewLinkList> WarehouseViewLinkListWithHttpInfo(string projectId, int? limit = default(int?), int? offset = default(int?), string search = default(string), int operationIndex = 0)
        {
            ...
            if (projectId == null)
            {
                throw new DotPostHog.Client.ApiException(400, "Missing required parameter 'projectId' when calling WarehouseViewLinkApi->WarehouseViewLinkList");
            }
            ...
            localVarRequestOptions.Operation = "WarehouseViewLinkApi.WarehouseViewLinkList";
            localVarRequestOptions.OperationIndex = operationIndex;
        ...
        public DotPostHog.Client.ApiResponse<PostHogViewLink> WarehouseViewLinkPartialUpdateWithHttpInfo(Guid id, string projectId, PostHogPatchedViewLink postHogPatchedViewLink = default(PostHogPatchedViewLink), int operationIndex = 0)
        {
            ...
            if (projectId == null)
            {
                throw new DotPostHog.Client.ApiException(400, "Missing required parameter 'projectId' when calling WarehouseViewLinkApi->WarehouseViewLinkPartialUpdate");
            }
        ...
        public DotPostHog.Client.ApiResponse<PostHogViewLink> WarehouseViewLinkRetrieveWithHttpInfo(Guid id, string projectId, int operationIndex = 0)
        {
            ...
            if (projectId == null)
            {
                throw new DotPostHog.Client.ApiException(400, "Missing required parameter 'projectId' when calling WarehouseViewLinkApi->WarehouseViewLinkRetrieve");
            }
            ...
            localVarRequestOptions.Operation = "WarehouseViewLinkApi.WarehouseViewLinkRetrieve";
            localVarRequestOptions.OperationIndex = operationIndex;
