...
namespace DotPostHog.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PatchedSubscription")]
    public partial class PostHogPatchedSubscription : IEquatable<PostHogPatchedSubscription>, IValidatableObject
    {
        /// <summary>
        /// Defines TargetType
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostHogPatchedSubscription" /> class.
        /// </summary>
        ...
        /// </summary>
        [DataMember(Name = "target_value", EmitDefaultValue = false)]
        ...
        public List<PostHogPatchedSubscription.ByweekdayEnum> Byweekday { get; set; }
        ...
        /// </summary>
        [DataMember(Name = "next_delivery_date", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostHogPatchedSubscription {\n");
        ...
        {
            return this.Equals(input as PostHogPatchedSubscription);
        }

        /// <summary>
        /// Returns true if PostHogPatchedSubscription instances are equal
        /// </summary>
        /// <param name="input">Instance of PostHogPatchedSubscription to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostHogPatchedSubscription input)
        {
            if (input == null)
            {
                return false;
