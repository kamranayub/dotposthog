...
namespace DotPostHog.Model
{
    ...
    public partial class PostHogPropertyItem : IEquatable<PostHogPropertyItem>, IValidatableObject
    {
        /// <summary>
        /// Defines VarOperator
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostHogPropertyItem" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostHogPropertyItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostHogPropertyItem" /> class.
        /// </summary>
        ...
        public PostHogPropertyItem(string key = default(string), string value = default(string), OperatorEnum? varOperator = OperatorEnum.Exact, TypeEnum? type = TypeEnum.Event)
        {
            // to ensure "key" is required (not null)
            if (key == null)
            {
                throw new ArgumentNullException("key is a required property for PostHogPropertyItem and cannot be null");
            }
            this.Key = key;
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for PostHogPropertyItem and cannot be null");
            }
            this.Value = value;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostHogPropertyItem {\n");
        ...
        {
            return this.Equals(input as PostHogPropertyItem);
        }

        /// <summary>
        /// Returns true if PostHogPropertyItem instances are equal
        /// </summary>
        /// <param name="input">Instance of PostHogPropertyItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostHogPropertyItem input)
        {
            if (input == null)
            {
                return false;
