...
namespace DotPostHog.Model
{
    ...
    public partial class PatchedOrganizationDomain : IEquatable<PatchedOrganizationDomain>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PatchedOrganizationDomain" /> class.
        /// </summary>
        ...
        public PatchedOrganizationDomain(string domain = default(string), bool jitProvisioningEnabled = default(bool), string ssoEnforcement = default(string), string samlEntityId = default(string), string samlAcsUrl = default(string), string samlX509Cert = default(string))
        {
            this.Domain = domain;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PatchedOrganizationDomain {\n");
        ...
        {
            return this.Equals(input as PatchedOrganizationDomain);
        }

        /// <summary>
        /// Returns true if PatchedOrganizationDomain instances are equal
        /// </summary>
        /// <param name="input">Instance of PatchedOrganizationDomain to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PatchedOrganizationDomain input)
        {
            if (input == null)
            {
                return false;
