...
namespace DotPostHog.Model
{
    ...
    public partial class Funnel : IEquatable<Funnel>, IValidatableObject
    {
        /// <summary>
        ...
        public Funnel(List<FilterEvent> events = default(List<FilterEvent>), List<FilterAction> actions = default(List<FilterAction>), Property properties = default(Property), bool filterTestAccounts = false, string dateFrom = @"-7d", string dateTo = @"-7d", string breakdown = default(string), BreakdownTypeEnum? breakdownType = BreakdownTypeEnum.Event, int funnelWindowInterval = 14, FunnelWindowIntervalTypeEnum? funnelWindowIntervalType = FunnelWindowIntervalTypeEnum.DAY, FunnelVizTypeEnum? funnelVizType = FunnelVizTypeEnum.Steps, FunnelOrderTypeEnum? funnelOrderType = FunnelOrderTypeEnum.Ordered, List<FunnelExclusion> exclusions = default(List<FunnelExclusion>), int aggregationGroupTypeIndex = 0, int breakdownLimit = 10, int funnelWindowDays = 14)
        {
            this.Events = events;
        ...
        public List<FilterEvent> Events { get; set; }
        ...
        public List<FunnelExclusion> Exclusions { get; set; }
        ...
        {
            return this.Equals(input as Funnel);
        }

        /// <summary>
        /// Returns true if Funnel instances are equal
        /// </summary>
        /// <param name="input">Instance of Funnel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Funnel input)
        {
            if (input == null)
            {
                return false;
