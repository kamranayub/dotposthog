...
{
    /// <summary>
    /// PostHogPatchedPluginConfig
    /// </summary>
    [DataContract(Name = "PatchedPluginConfig")]
    public partial class PostHogPatchedPluginConfig : IEquatable<PostHogPatchedPluginConfig>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostHogPatchedPluginConfig" /> class.
        /// </summary>
        ...
        public PostHogPatchedPluginConfig(int plugin = default(int), bool enabled = default(bool), int order = default(int), Dictionary<string, Object> error = default(Dictionary<string, Object>), string name = default(string), string description = default(string), bool? deleted = default(bool?))
        {
            this.Plugin = plugin;
        ...
        /// </summary>
        [DataMember(Name = "plugin_info", EmitDefaultValue = false)]
        ...
        /// </summary>
        [DataMember(Name = "delivery_rate_24h", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostHogPatchedPluginConfig {\n");
        ...
        {
            return this.Equals(input as PostHogPatchedPluginConfig);
        }

        /// <summary>
        /// Returns true if PostHogPatchedPluginConfig instances are equal
        /// </summary>
        /// <param name="input">Instance of PostHogPatchedPluginConfig to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostHogPatchedPluginConfig input)
        {
            if (input == null)
            {
                return false;
