...
namespace DotPostHog.Model
{
    ...
    public partial class PostHogUserBasic : IEquatable<PostHogUserBasic>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostHogUserBasic" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostHogUserBasic() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostHogUserBasic" /> class.
        /// </summary>
        ...
        public PostHogUserBasic(string distinctId = default(string), string firstName = default(string), string email = default(string), bool? isEmailVerified = default(bool?))
        {
            // to ensure "email" is required (not null)
            if (email == null)
            {
                throw new ArgumentNullException("email is a required property for PostHogUserBasic and cannot be null");
            }
            this.Email = email;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostHogUserBasic {\n");
        ...
        {
            return this.Equals(input as PostHogUserBasic);
        }

        /// <summary>
        /// Returns true if PostHogUserBasic instances are equal
        /// </summary>
        /// <param name="input">Instance of PostHogUserBasic to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostHogUserBasic input)
        {
            if (input == null)
            {
                return false;
