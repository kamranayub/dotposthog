...
namespace DotPostHog.Model
{
    ...
    public partial class PostHogActionStep : IEquatable<PostHogActionStep>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostHogActionStep" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostHogActionStep {\n");
        ...
        {
            return this.Equals(input as PostHogActionStep);
        }

        /// <summary>
        /// Returns true if PostHogActionStep instances are equal
        /// </summary>
        /// <param name="input">Instance of PostHogActionStep to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostHogActionStep input)
        {
            if (input == null)
            {
                return false;
