...
namespace DotPostHog.Model
{
    ...
    public partial class PostHogViewLink : IEquatable<PostHogViewLink>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostHogViewLink" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostHogViewLink() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostHogViewLink" /> class.
        /// </summary>
        ...
        public PostHogViewLink(bool? deleted = default(bool?), string table = default(string), Guid savedQueryId = default(Guid), string toJoinKey = default(string), string fromJoinKey = default(string))
        {
            // to ensure "table" is required (not null)
            if (table == null)
            {
                throw new ArgumentNullException("table is a required property for PostHogViewLink and cannot be null");
            }
            this.Table = table;
            ...
            if (toJoinKey == null)
            {
                throw new ArgumentNullException("toJoinKey is a required property for PostHogViewLink and cannot be null");
            }
            this.ToJoinKey = toJoinKey;
            // to ensure "fromJoinKey" is required (not null)
            if (fromJoinKey == null)
            {
                throw new ArgumentNullException("fromJoinKey is a required property for PostHogViewLink and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostHogViewLink {\n");
        ...
        {
            return this.Equals(input as PostHogViewLink);
        }

        /// <summary>
        /// Returns true if PostHogViewLink instances are equal
        /// </summary>
        /// <param name="input">Instance of PostHogViewLink to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostHogViewLink input)
        {
            if (input == null)
            {
                return false;
