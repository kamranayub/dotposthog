...
namespace DotPostHog.Model
{
    ...
    /// PostHogTrendResults
    /// </summary>
    [DataContract(Name = "TrendResults")]
    public partial class PostHogTrendResults : IEquatable<PostHogTrendResults>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostHogTrendResults" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostHogTrendResults() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostHogTrendResults" /> class.
        /// </summary>
        ...
        public PostHogTrendResults(bool isCached = default(bool), DateTime lastRefresh = default(DateTime), TimezoneEnum? timezone = TimezoneEnum.UTC, List<PostHogTrendResult> result = default(List<PostHogTrendResult>))
        {
            ...
            if (result == null)
            {
                throw new ArgumentNullException("result is a required property for PostHogTrendResults and cannot be null");
            }
            this.Result = result;
        ...
        public List<PostHogTrendResult> Result { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostHogTrendResults {\n");
        ...
        {
            return this.Equals(input as PostHogTrendResults);
        }

        /// <summary>
        /// Returns true if PostHogTrendResults instances are equal
        /// </summary>
        /// <param name="input">Instance of PostHogTrendResults to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostHogTrendResults input)
        {
            if (input == null)
            {
                return false;
