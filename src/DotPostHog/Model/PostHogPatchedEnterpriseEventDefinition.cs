...
namespace DotPostHog.Model
{
    ...
    public partial class PostHogPatchedEnterpriseEventDefinition : IEquatable<PostHogPatchedEnterpriseEventDefinition>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostHogPatchedEnterpriseEventDefinition" /> class.
        /// </summary>
        ...
        public PostHogPatchedEnterpriseEventDefinition(int? owner = default(int?), string description = default(string), List<Object> tags = default(List<Object>), bool verified = default(bool), bool postToSlack = false)
        {
            this.Owner = owner;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostHogPatchedEnterpriseEventDefinition {\n");
        ...
        {
            return this.Equals(input as PostHogPatchedEnterpriseEventDefinition);
        }

        /// <summary>
        /// Returns true if PostHogPatchedEnterpriseEventDefinition instances are equal
        /// </summary>
        /// <param name="input">Instance of PostHogPatchedEnterpriseEventDefinition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostHogPatchedEnterpriseEventDefinition input)
        {
            if (input == null)
            {
                return false;
