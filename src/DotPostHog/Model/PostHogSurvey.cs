...
namespace DotPostHog.Model
{
    ...
    public partial class PostHogSurvey : IEquatable<PostHogSurvey>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostHogSurvey" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostHogSurvey() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostHogSurvey" /> class.
        /// </summary>
        ...
        public PostHogSurvey(string name = default(string), string description = default(string), TypeEnum type = default(TypeEnum), int? linkedFlagId = default(int?), Dictionary<string, Object> questions = default(Dictionary<string, Object>), Dictionary<string, Object> conditions = default(Dictionary<string, Object>), Dictionary<string, Object> appearance = default(Dictionary<string, Object>), DateTime? startDate = default(DateTime?), DateTime? endDate = default(DateTime?), bool archived = default(bool))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for PostHogSurvey and cannot be null");
            }
            this.Name = name;
            this.Type = type;
        ...
        {
            return this.Equals(input as PostHogSurvey);
        }

        /// <summary>
        /// Returns true if PostHogSurvey instances are equal
        /// </summary>
        /// <param name="input">Instance of PostHogSurvey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostHogSurvey input)
        {
            if (input == null)
            {
                return false;
