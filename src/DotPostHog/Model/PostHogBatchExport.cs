...
namespace DotPostHog.Model
{
    ...
    public partial class PostHogBatchExport : IEquatable<PostHogBatchExport>, IValidatableObject
    {
        /// <summary>
        /// Defines Interval
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostHogBatchExport" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostHogBatchExport() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostHogBatchExport" /> class.
        /// </summary>
        ...
        public PostHogBatchExport(string name = default(string), PostHogBatchExportDestination destination = default(PostHogBatchExportDestination), IntervalEnum interval = default(IntervalEnum), bool paused = default(bool), DateTime? lastPausedAt = default(DateTime?), DateTime? startAt = default(DateTime?), DateTime? endAt = default(DateTime?))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for PostHogBatchExport and cannot be null");
            }
            this.Name = name;
            // to ensure "destination" is required (not null)
            if (destination == null)
            {
                throw new ArgumentNullException("destination is a required property for PostHogBatchExport and cannot be null");
            }
        ...
        public PostHogBatchExportDestination Destination { get; set; }
        ...
        public List<PostHogBatchExportRun> LatestRuns { get; private set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostHogBatchExport {\n");
        ...
        {
            return this.Equals(input as PostHogBatchExport);
        }

        /// <summary>
        /// Returns true if PostHogBatchExport instances are equal
        /// </summary>
        /// <param name="input">Instance of PostHogBatchExport to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostHogBatchExport input)
        {
            if (input == null)
            {
                return false;
