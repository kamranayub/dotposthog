...
namespace DotPostHog.Model
{
    ...
    public partial class PostHogPluginConfig : IEquatable<PostHogPluginConfig>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostHogPluginConfig" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostHogPluginConfig() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostHogPluginConfig" /> class.
        /// </summary>
        ...
        public PostHogPluginConfig(int plugin = default(int), bool enabled = default(bool), int order = default(int), Dictionary<string, Object> error = default(Dictionary<string, Object>), string name = default(string), string description = default(string), bool? deleted = default(bool?))
        {
            this.Plugin = plugin;
            this.Order = order;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostHogPluginConfig {\n");
        ...
        {
            return this.Equals(input as PostHogPluginConfig);
        }

        /// <summary>
        /// Returns true if PostHogPluginConfig instances are equal
        /// </summary>
        /// <param name="input">Instance of PostHogPluginConfig to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostHogPluginConfig input)
        {
            if (input == null)
            {
                return false;
