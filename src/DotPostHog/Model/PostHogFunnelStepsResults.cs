...
{
    /// <summary>
    /// PostHogFunnelStepsResults
    /// </summary>
    [DataContract(Name = "FunnelStepsResults")]
    public partial class PostHogFunnelStepsResults : IEquatable<PostHogFunnelStepsResults>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostHogFunnelStepsResults" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostHogFunnelStepsResults() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostHogFunnelStepsResults" /> class.
        /// </summary>
        ...
        public PostHogFunnelStepsResults(bool isCached = default(bool), DateTime lastRefresh = default(DateTime), TimezoneEnum? timezone = TimezoneEnum.UTC, List<PostHogFunnelStepsResult> result = default(List<PostHogFunnelStepsResult>))
        {
            ...
            if (result == null)
            {
                throw new ArgumentNullException("result is a required property for PostHogFunnelStepsResults and cannot be null");
            }
            this.Result = result;
        ...
        public List<PostHogFunnelStepsResult> Result { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostHogFunnelStepsResults {\n");
        ...
        {
            return this.Equals(input as PostHogFunnelStepsResults);
        }

        /// <summary>
        /// Returns true if PostHogFunnelStepsResults instances are equal
        /// </summary>
        /// <param name="input">Instance of PostHogFunnelStepsResults to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostHogFunnelStepsResults input)
        {
            if (input == null)
            {
                return false;
