...
namespace DotPostHog.Model
{
    ...
    public partial class PatchedSubscription : IEquatable<PatchedSubscription>, IValidatableObject
    {
        /// <summary>
        /// Defines TargetType
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PatchedSubscription" /> class.
        /// </summary>
        ...
        public List<PatchedSubscription.ByweekdayEnum> Byweekday { get; set; }
        ...
        {
            return this.Equals(input as PatchedSubscription);
        }

        /// <summary>
        /// Returns true if PatchedSubscription instances are equal
        /// </summary>
        /// <param name="input">Instance of PatchedSubscription to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PatchedSubscription input)
        {
            if (input == null)
            {
                return false;
