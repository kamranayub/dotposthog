...
{
    /// <summary>
    /// PostHogPatchedSurveySerializerCreateUpdateOnly
    /// </summary>
    [DataContract(Name = "PatchedSurveySerializerCreateUpdateOnly")]
    public partial class PostHogPatchedSurveySerializerCreateUpdateOnly : IEquatable<PostHogPatchedSurveySerializerCreateUpdateOnly>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostHogPatchedSurveySerializerCreateUpdateOnly" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostHogPatchedSurveySerializerCreateUpdateOnly {\n");
        ...
        {
            return this.Equals(input as PostHogPatchedSurveySerializerCreateUpdateOnly);
        }

        /// <summary>
        /// Returns true if PostHogPatchedSurveySerializerCreateUpdateOnly instances are equal
        /// </summary>
        /// <param name="input">Instance of PostHogPatchedSurveySerializerCreateUpdateOnly to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostHogPatchedSurveySerializerCreateUpdateOnly input)
        {
            if (input == null)
            {
                return false;
