...
namespace DotPostHog.Model
{
    ...
    public partial class PostHogRole : IEquatable<PostHogRole>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostHogRole" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostHogRole() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostHogRole" /> class.
        /// </summary>
        /// <param name="name">name (required).</param>
        /// <param name="featureFlagsAccessLevel">featureFlagsAccessLevel.</param>
        public PostHogRole(string name = default(string), FeatureFlagsAccessLevelEnum? featureFlagsAccessLevel = default(FeatureFlagsAccessLevelEnum?))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for PostHogRole and cannot be null");
            }
            this.Name = name;
        ...
        /// </summary>
        [DataMember(Name = "associated_flags", IsRequired = true, EmitDefaultValue = true)]
        ...
        {
            return this.Equals(input as PostHogRole);
        }

        /// <summary>
        /// Returns true if PostHogRole instances are equal
        /// </summary>
        /// <param name="input">Instance of PostHogRole to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostHogRole input)
        {
            if (input == null)
            {
                return false;
