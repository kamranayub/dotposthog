...
namespace DotPostHog.Model
{
    ...
    public partial class PatchedTeam : IEquatable<PatchedTeam>, IValidatableObject
    {
        /// <summary>
        /// Defines Timezone
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PatchedTeam" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as PatchedTeam);
        }

        /// <summary>
        /// Returns true if PatchedTeam instances are equal
        /// </summary>
        /// <param name="input">Instance of PatchedTeam to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PatchedTeam input)
        {
            if (input == null)
            {
                return false;
