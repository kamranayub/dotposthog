...
namespace DotPostHog.Model
{
    ...
    public partial class PostHogAction : IEquatable<PostHogAction>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostHogAction" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostHogAction() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostHogAction" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as PostHogAction);
        }

        /// <summary>
        /// Returns true if PostHogAction instances are equal
        /// </summary>
        /// <param name="input">Instance of PostHogAction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostHogAction input)
        {
            if (input == null)
            {
                return false;
