...
namespace DotPostHog.Model
{
    ...
    /// PostHogCohort
    /// </summary>
    [DataContract(Name = "Cohort")]
    public partial class PostHogCohort : IEquatable<PostHogCohort>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostHogCohort" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostHogCohort() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostHogCohort" /> class.
        /// </summary>
        ...
        public PostHogCohort(string name = default(string), string description = default(string), Dictionary<string, Object> groups = default(Dictionary<string, Object>), bool deleted = default(bool), Dictionary<string, Object> filters = default(Dictionary<string, Object>), bool isStatic = default(bool))
        {
            this.Name = name;
        ...
        /// </summary>
        [DataMember(Name = "last_calculation", IsRequired = true, EmitDefaultValue = true)]
        ...
        /// </summary>
        [DataMember(Name = "errors_calculating", IsRequired = true, EmitDefaultValue = true)]
        ...
        {
            return this.Equals(input as PostHogCohort);
        }

        /// <summary>
        /// Returns true if PostHogCohort instances are equal
        /// </summary>
        /// <param name="input">Instance of PostHogCohort to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostHogCohort input)
        {
            if (input == null)
            {
                return false;
