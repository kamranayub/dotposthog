...
namespace DotPostHog.Model
{
    ...
    public partial class Annotation : IEquatable<Annotation>, IValidatableObject
    {
        ...
        public Annotation(string content = default(string), DateTime? dateMarker = default(DateTime?), CreationTypeEnum? creationType = default(CreationTypeEnum?), int? dashboardItem = default(int?), bool deleted = default(bool), ScopeEnum? scope = default(ScopeEnum?))
        {
