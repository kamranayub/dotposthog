...
{
    /// <summary>
    /// PostHogEarlyAccessFeatureSerializerCreateOnly
    /// </summary>
    [DataContract(Name = "EarlyAccessFeatureSerializerCreateOnly")]
    public partial class PostHogEarlyAccessFeatureSerializerCreateOnly : IEquatable<PostHogEarlyAccessFeatureSerializerCreateOnly>, IValidatableObject
    {
        /// <summary>
        /// Defines Stage
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostHogEarlyAccessFeatureSerializerCreateOnly" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostHogEarlyAccessFeatureSerializerCreateOnly() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostHogEarlyAccessFeatureSerializerCreateOnly" /> class.
        /// </summary>
        ...
        /// <param name="featureFlagId">featureFlagId.</param>
        public PostHogEarlyAccessFeatureSerializerCreateOnly(string name = default(string), string description = default(string), StageEnum stage = default(StageEnum), string documentationUrl = default(string), int featureFlagId = default(int))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for PostHogEarlyAccessFeatureSerializerCreateOnly and cannot be null");
            }
            this.Name = name;
            this.Stage = stage;
        ...
        /// <summary>
        /// Gets or Sets FeatureFlagId
        /// </summary>
        [DataMember(Name = "feature_flag_id", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostHogEarlyAccessFeatureSerializerCreateOnly {\n");
            ...
            sb.Append("  FeatureFlagId: ").Append(FeatureFlagId).Append("\n");
        ...
        {
            return this.Equals(input as PostHogEarlyAccessFeatureSerializerCreateOnly);
        }

        /// <summary>
        /// Returns true if PostHogEarlyAccessFeatureSerializerCreateOnly instances are equal
        /// </summary>
        /// <param name="input">Instance of PostHogEarlyAccessFeatureSerializerCreateOnly to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostHogEarlyAccessFeatureSerializerCreateOnly input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.FeatureFlagId == input.FeatureFlagId ||
                    this.FeatureFlagId.Equals(input.FeatureFlagId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.FeatureFlagId.GetHashCode();
