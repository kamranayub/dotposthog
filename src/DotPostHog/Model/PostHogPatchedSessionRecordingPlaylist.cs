...
namespace DotPostHog.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PatchedSessionRecordingPlaylist")]
    public partial class PostHogPatchedSessionRecordingPlaylist : IEquatable<PostHogPatchedSessionRecordingPlaylist>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostHogPatchedSessionRecordingPlaylist" /> class.
        /// </summary>
        ...
        public PostHogPatchedSessionRecordingPlaylist(string name = default(string), string derivedName = default(string), string description = default(string), bool pinned = default(bool), bool deleted = default(bool), Dictionary<string, Object> filters = default(Dictionary<string, Object>))
        {
            this.Name = name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostHogPatchedSessionRecordingPlaylist {\n");
        ...
        {
            return this.Equals(input as PostHogPatchedSessionRecordingPlaylist);
        }

        /// <summary>
        /// Returns true if PostHogPatchedSessionRecordingPlaylist instances are equal
        /// </summary>
        /// <param name="input">Instance of PostHogPatchedSessionRecordingPlaylist to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostHogPatchedSessionRecordingPlaylist input)
        {
            if (input == null)
            {
                return false;
