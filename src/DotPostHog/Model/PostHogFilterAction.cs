...
namespace DotPostHog.Model
{
    ...
    /// PostHogFilterAction
    /// </summary>
    [DataContract(Name = "FilterAction")]
    public partial class PostHogFilterAction : IEquatable<PostHogFilterAction>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostHogFilterAction" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostHogFilterAction() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostHogFilterAction" /> class.
        /// </summary>
        /// <param name="id">ID of the action to filter on. For example &#x60;2841&#x60;. (required).</param>
        ...
        public PostHogFilterAction(string id = default(string), List<PostHogProperty> properties = default(List<PostHogProperty>), MathEnum? math = MathEnum.Total)
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for PostHogFilterAction and cannot be null");
            }
            this.Id = id;
        ...
        /// </summary>
        /// <value>ID of the action to filter on. For example &#x60;2841&#x60;.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostHogFilterAction {\n");
        ...
        {
            return this.Equals(input as PostHogFilterAction);
        }

        /// <summary>
        /// Returns true if PostHogFilterAction instances are equal
        /// </summary>
        /// <param name="input">Instance of PostHogFilterAction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostHogFilterAction input)
        {
            if (input == null)
            {
                return false;
