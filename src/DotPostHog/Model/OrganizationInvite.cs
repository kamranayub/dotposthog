...
namespace DotPostHog.Model
{
    ...
    public partial class OrganizationInvite : IEquatable<OrganizationInvite>, IValidatableObject
    {
        /// <summary>
        ...
        public OrganizationInvite(string targetEmail = default(string), string firstName = default(string), string message = default(string))
        {
            // to ensure "targetEmail" is required (not null)
            if (targetEmail == null)
            {
                throw new ArgumentNullException("targetEmail is a required property for OrganizationInvite and cannot be null");
            }
        ...
        {
            return this.Equals(input as OrganizationInvite);
        }

        /// <summary>
        /// Returns true if OrganizationInvite instances are equal
        /// </summary>
        /// <param name="input">Instance of OrganizationInvite to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrganizationInvite input)
        {
            if (input == null)
            {
                return false;
