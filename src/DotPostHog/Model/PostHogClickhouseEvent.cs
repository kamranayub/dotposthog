...
{
    /// <summary>
    /// PostHogClickhouseEvent
    /// </summary>
    [DataContract(Name = "ClickhouseEvent")]
    public partial class PostHogClickhouseEvent : IEquatable<PostHogClickhouseEvent>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostHogClickhouseEvent" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public PostHogClickhouseEvent()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostHogClickhouseEvent {\n");
        ...
        {
            return this.Equals(input as PostHogClickhouseEvent);
        }

        /// <summary>
        /// Returns true if PostHogClickhouseEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of PostHogClickhouseEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostHogClickhouseEvent input)
        {
            if (input == null)
            {
                return false;
