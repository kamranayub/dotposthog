...
{
    /// <summary>
    /// PostHogPatchedCohort
    /// </summary>
    [DataContract(Name = "PatchedCohort")]
    public partial class PostHogPatchedCohort : IEquatable<PostHogPatchedCohort>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostHogPatchedCohort" /> class.
        /// </summary>
        ...
        public PostHogPatchedCohort(string name = default(string), string description = default(string), Dictionary<string, Object> groups = default(Dictionary<string, Object>), bool deleted = default(bool), Dictionary<string, Object> filters = default(Dictionary<string, Object>), bool isStatic = default(bool))
        {
            this.Name = name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostHogPatchedCohort {\n");
        ...
        {
            return this.Equals(input as PostHogPatchedCohort);
        }

        /// <summary>
        /// Returns true if PostHogPatchedCohort instances are equal
        /// </summary>
        /// <param name="input">Instance of PostHogPatchedCohort to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostHogPatchedCohort input)
        {
            if (input == null)
            {
                return false;
