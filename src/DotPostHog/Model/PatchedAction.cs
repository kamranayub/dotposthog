...
namespace DotPostHog.Model
{
    ...
    public partial class PatchedAction : IEquatable<PatchedAction>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PatchedAction" /> class.
        /// </summary>
        ...
        public PatchedAction(string name = default(string), string description = default(string), List<Object> tags = default(List<Object>), bool postToSlack = default(bool), string slackMessageFormat = default(string), List<ActionStep> steps = default(List<ActionStep>), bool deleted = default(bool), DateTime lastCalculatedAt = default(DateTime))
        {
            this.Name = name;
        ...
        {
            return this.Equals(input as PatchedAction);
        }

        /// <summary>
        /// Returns true if PatchedAction instances are equal
        /// </summary>
        /// <param name="input">Instance of PatchedAction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PatchedAction input)
        {
            if (input == null)
            {
                return false;
