...
{
    /// <summary>
    /// PostHogEarlyAccessFeature
    /// </summary>
    [DataContract(Name = "EarlyAccessFeature")]
    public partial class PostHogEarlyAccessFeature : IEquatable<PostHogEarlyAccessFeature>, IValidatableObject
    {
        /// <summary>
        /// Defines Stage
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostHogEarlyAccessFeature" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostHogEarlyAccessFeature() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostHogEarlyAccessFeature" /> class.
        /// </summary>
        ...
        public PostHogEarlyAccessFeature(string name = default(string), string description = default(string), StageEnum stage = default(StageEnum), string documentationUrl = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for PostHogEarlyAccessFeature and cannot be null");
            }
            this.Name = name;
            this.Stage = stage;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostHogEarlyAccessFeature {\n");
        ...
        {
            return this.Equals(input as PostHogEarlyAccessFeature);
        }

        /// <summary>
        /// Returns true if PostHogEarlyAccessFeature instances are equal
        /// </summary>
        /// <param name="input">Instance of PostHogEarlyAccessFeature to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostHogEarlyAccessFeature input)
        {
            if (input == null)
            {
                return false;
