...
{
    /// <summary>
    /// PostHogMinimalFeatureFlag
    /// </summary>
    [DataContract(Name = "MinimalFeatureFlag")]
    public partial class PostHogMinimalFeatureFlag : IEquatable<PostHogMinimalFeatureFlag>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostHogMinimalFeatureFlag" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostHogMinimalFeatureFlag() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostHogMinimalFeatureFlag" /> class.
        /// </summary>
        ...
        public PostHogMinimalFeatureFlag(string name = default(string), string key = default(string), Dictionary<string, Object> filters = default(Dictionary<string, Object>), bool deleted = default(bool), bool active = default(bool), bool? ensureExperienceContinuity = default(bool?))
        {
            // to ensure "key" is required (not null)
            if (key == null)
            {
                throw new ArgumentNullException("key is a required property for PostHogMinimalFeatureFlag and cannot be null");
            }
            this.Key = key;
            this.Name = name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostHogMinimalFeatureFlag {\n");
        ...
        {
            return this.Equals(input as PostHogMinimalFeatureFlag);
        }

        /// <summary>
        /// Returns true if PostHogMinimalFeatureFlag instances are equal
        /// </summary>
        /// <param name="input">Instance of PostHogMinimalFeatureFlag to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostHogMinimalFeatureFlag input)
        {
            if (input == null)
            {
                return false;
