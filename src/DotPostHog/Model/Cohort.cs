...
namespace DotPostHog.Model
{
    ...
    public partial class Cohort : IEquatable<Cohort>, IValidatableObject
    {
        /// <summary>
        ...
        public Cohort(string name = default(string), string description = default(string), Dictionary<string, Object> groups = default(Dictionary<string, Object>), bool deleted = default(bool), Dictionary<string, Object> filters = default(Dictionary<string, Object>), bool isStatic = default(bool))
        {
            this.Name = name;
        ...
        {
            return this.Equals(input as Cohort);
        }

        /// <summary>
        /// Returns true if Cohort instances are equal
        /// </summary>
        /// <param name="input">Instance of Cohort to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Cohort input)
        {
            if (input == null)
            {
                return false;
