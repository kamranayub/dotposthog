...
namespace DotPostHog.Model
{
    ...
    public partial class PatchedFeatureFlag : IEquatable<PatchedFeatureFlag>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PatchedFeatureFlag" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PatchedFeatureFlag {\n");
        ...
        {
            return this.Equals(input as PatchedFeatureFlag);
        }

        /// <summary>
        /// Returns true if PatchedFeatureFlag instances are equal
        /// </summary>
        /// <param name="input">Instance of PatchedFeatureFlag to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PatchedFeatureFlag input)
        {
            if (input == null)
            {
                return false;
