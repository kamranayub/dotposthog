...
namespace DotPostHog.Model
{
    ...
    public partial class FilterEvent : IEquatable<FilterEvent>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FilterEvent" /> class.
        /// </summary>
        ...
        public FilterEvent(string id = default(string), List<Property> properties = default(List<Property>), MathEnum? math = MathEnum.Total)
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for FilterEvent and cannot be null");
            }
            this.Id = id;
        ...
        {
            return this.Equals(input as FilterEvent);
        }

        /// <summary>
        /// Returns true if FilterEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of FilterEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FilterEvent input)
        {
            if (input == null)
            {
                return false;
