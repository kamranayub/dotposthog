...
namespace DotPostHog.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PatchedAction")]
    public partial class PostHogPatchedAction : IEquatable<PostHogPatchedAction>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostHogPatchedAction" /> class.
        /// </summary>
        ...
        public PostHogPatchedAction(string name = default(string), string description = default(string), List<Object> tags = default(List<Object>), bool postToSlack = default(bool), string slackMessageFormat = default(string), List<PostHogActionStep> steps = default(List<PostHogActionStep>), bool deleted = default(bool), DateTime lastCalculatedAt = default(DateTime))
        {
            this.Name = name;
        ...
        /// </summary>
        [DataMember(Name = "is_action", EmitDefaultValue = true)]
        ...
        /// </summary>
        [DataMember(Name = "bytecode_error", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostHogPatchedAction {\n");
        ...
        {
            return this.Equals(input as PostHogPatchedAction);
        }

        /// <summary>
        /// Returns true if PostHogPatchedAction instances are equal
        /// </summary>
        /// <param name="input">Instance of PostHogPatchedAction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostHogPatchedAction input)
        {
            if (input == null)
            {
                return false;
