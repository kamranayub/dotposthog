...
namespace DotPostHog.Model
{
    ...
    public partial class BatchExportRun : IEquatable<BatchExportRun>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BatchExportRun" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BatchExportRun() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BatchExportRun" /> class.
        /// </summary>
        ...
        public BatchExportRun(StatusEnum status = default(StatusEnum), int? recordsCompleted = default(int?), string latestError = default(string), DateTime dataIntervalStart = default(DateTime), DateTime dataIntervalEnd = default(DateTime), string cursor = default(string), DateTime? finishedAt = default(DateTime?))
        {
            this.Status = status;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BatchExportRun {\n");
        ...
        {
            return this.Equals(input as BatchExportRun);
        }

        /// <summary>
        /// Returns true if BatchExportRun instances are equal
        /// </summary>
        /// <param name="input">Instance of BatchExportRun to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BatchExportRun input)
        {
            if (input == null)
            {
                return false;
