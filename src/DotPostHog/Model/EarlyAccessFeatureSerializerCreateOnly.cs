...
namespace DotPostHog.Model
{
    ...
    public partial class EarlyAccessFeatureSerializerCreateOnly : IEquatable<EarlyAccessFeatureSerializerCreateOnly>, IValidatableObject
    {
        /// <summary>
        /// Defines Stage
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EarlyAccessFeatureSerializerCreateOnly" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EarlyAccessFeatureSerializerCreateOnly() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EarlyAccessFeatureSerializerCreateOnly" /> class.
        /// </summary>
        ...
        public EarlyAccessFeatureSerializerCreateOnly(string name = default(string), string description = default(string), StageEnum stage = default(StageEnum), string documentationUrl = default(string), int featureFlagId = default(int))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for EarlyAccessFeatureSerializerCreateOnly and cannot be null");
            }
            this.Name = name;
            this.Stage = stage;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EarlyAccessFeatureSerializerCreateOnly {\n");
        ...
        {
            return this.Equals(input as EarlyAccessFeatureSerializerCreateOnly);
        }

        /// <summary>
        /// Returns true if EarlyAccessFeatureSerializerCreateOnly instances are equal
        /// </summary>
        /// <param name="input">Instance of EarlyAccessFeatureSerializerCreateOnly to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EarlyAccessFeatureSerializerCreateOnly input)
        {
            if (input == null)
            {
                return false;
