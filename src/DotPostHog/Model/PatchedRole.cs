...
namespace DotPostHog.Model
{
    ...
    public partial class PatchedRole : IEquatable<PatchedRole>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PatchedRole" /> class.
        /// </summary>
        /// <param name="name">name.</param>
        /// <param name="featureFlagsAccessLevel">featureFlagsAccessLevel.</param>
        public PatchedRole(string name = default(string), FeatureFlagsAccessLevelEnum? featureFlagsAccessLevel = default(FeatureFlagsAccessLevelEnum?))
        {
            this.Name = name;
        ...
        {
            return this.Equals(input as PatchedRole);
        }

        /// <summary>
        /// Returns true if PatchedRole instances are equal
        /// </summary>
        /// <param name="input">Instance of PatchedRole to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PatchedRole input)
        {
            if (input == null)
            {
                return false;
