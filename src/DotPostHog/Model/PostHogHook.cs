...
namespace DotPostHog.Model
{
    ...
    public partial class PostHogHook : IEquatable<PostHogHook>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostHogHook" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostHogHook() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostHogHook" /> class.
        /// </summary>
        ...
        public PostHogHook(string id = default(string), string varEvent = default(string), string target = default(string), int? resourceId = default(int?))
        {
            // to ensure "varEvent" is required (not null)
            if (varEvent == null)
            {
                throw new ArgumentNullException("varEvent is a required property for PostHogHook and cannot be null");
            }
            this.VarEvent = varEvent;
            // to ensure "target" is required (not null)
            if (target == null)
            {
                throw new ArgumentNullException("target is a required property for PostHogHook and cannot be null");
            }
            this.Target = target;
            this.Id = id;
        ...
        {
            return this.Equals(input as PostHogHook);
        }

        /// <summary>
        /// Returns true if PostHogHook instances are equal
        /// </summary>
        /// <param name="input">Instance of PostHogHook to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostHogHook input)
        {
            if (input == null)
            {
                return false;
