...
{
    /// <summary>
    /// PostHogPatchedPlugin
    /// </summary>
    [DataContract(Name = "PatchedPlugin")]
    public partial class PostHogPatchedPlugin : IEquatable<PostHogPatchedPlugin>, IValidatableObject
    {
        /// <summary>
        /// Defines PluginType
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostHogPatchedPlugin" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostHogPatchedPlugin {\n");
        ...
        {
            return this.Equals(input as PostHogPatchedPlugin);
        }

        /// <summary>
        /// Returns true if PostHogPatchedPlugin instances are equal
        /// </summary>
        /// <param name="input">Instance of PostHogPatchedPlugin to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostHogPatchedPlugin input)
        {
            if (input == null)
            {
                return false;
