...
namespace DotPostHog.Model
{
    ...
    public partial class PostHogSessionRecording : IEquatable<PostHogSessionRecording>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostHogSessionRecording" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostHogSessionRecording() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostHogSessionRecording" /> class.
        /// </summary>
        /// <param name="person">person.</param>
        public PostHogSessionRecording(PostHogMinimalPerson person = default(PostHogMinimalPerson))
        {
            this.Person = person;
        }
        ...
        public PostHogMinimalPerson Person { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostHogSessionRecording {\n");
        ...
        {
            return this.Equals(input as PostHogSessionRecording);
        }

        /// <summary>
        /// Returns true if PostHogSessionRecording instances are equal
        /// </summary>
        /// <param name="input">Instance of PostHogSessionRecording to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostHogSessionRecording input)
        {
            if (input == null)
            {
                return false;
