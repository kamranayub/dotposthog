...
namespace DotPostHog.Model
{
    ...
    public partial class PatchedGroupType : IEquatable<PatchedGroupType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PatchedGroupType" /> class.
        /// </summary>
        /// <param name="nameSingular">nameSingular.</param>
        /// <param name="namePlural">namePlural.</param>
        public PatchedGroupType(string nameSingular = default(string), string namePlural = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PatchedGroupType {\n");
        ...
        {
            return this.Equals(input as PatchedGroupType);
        }

        /// <summary>
        /// Returns true if PatchedGroupType instances are equal
        /// </summary>
        /// <param name="input">Instance of PatchedGroupType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PatchedGroupType input)
        {
            if (input == null)
            {
                return false;
