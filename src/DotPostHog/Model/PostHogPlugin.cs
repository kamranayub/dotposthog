...
namespace DotPostHog.Model
{
    ...
    public partial class PostHogPlugin : IEquatable<PostHogPlugin>, IValidatableObject
    {
        /// <summary>
        /// Defines PluginType
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostHogPlugin" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostHogPlugin() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostHogPlugin" /> class.
        /// </summary>
        ...
        /// </summary>
        [DataMember(Name = "latest_tag", IsRequired = true, EmitDefaultValue = true)]
        ...
        {
            return this.Equals(input as PostHogPlugin);
        }

        /// <summary>
        /// Returns true if PostHogPlugin instances are equal
        /// </summary>
        /// <param name="input">Instance of PostHogPlugin to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostHogPlugin input)
        {
            if (input == null)
            {
                return false;
