...
namespace DotPostHog.Model
{
    ...
    public partial class PluginLogEntry : IEquatable<PluginLogEntry>, IValidatableObject
    {
        /// <summary>
        /// Defines Source
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PluginLogEntry" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PluginLogEntry() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PluginLogEntry" /> class.
        /// </summary>
        ...
        public PluginLogEntry(Guid id = default(Guid), int teamId = default(int), int pluginId = default(int), int pluginConfigId = default(int), DateTime timestamp = default(DateTime), SourceEnum source = default(SourceEnum), TypeEnum type = default(TypeEnum), string message = default(string), Guid instanceId = default(Guid))
        {
            this.Id = id;
            this.TeamId = teamId;
            ...
            if (message == null)
            {
                throw new ArgumentNullException("message is a required property for PluginLogEntry and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PluginLogEntry {\n");
        ...
        {
            return this.Equals(input as PluginLogEntry);
        }

        /// <summary>
        /// Returns true if PluginLogEntry instances are equal
        /// </summary>
        /// <param name="input">Instance of PluginLogEntry to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PluginLogEntry input)
        {
            if (input == null)
            {
                return false;
