...
{
    /// <summary>
    /// PostHogPatchedOrganizationDomain
    /// </summary>
    [DataContract(Name = "PatchedOrganizationDomain")]
    public partial class PostHogPatchedOrganizationDomain : IEquatable<PostHogPatchedOrganizationDomain>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostHogPatchedOrganizationDomain" /> class.
        /// </summary>
        ...
        public PostHogPatchedOrganizationDomain(string domain = default(string), bool jitProvisioningEnabled = default(bool), string ssoEnforcement = default(string), string samlEntityId = default(string), string samlAcsUrl = default(string), string samlX509Cert = default(string))
        {
            this.Domain = domain;
        ...
        /// </summary>
        [DataMember(Name = "verification_challenge", EmitDefaultValue = false)]
        ...
        /// </summary>
        [DataMember(Name = "has_saml", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostHogPatchedOrganizationDomain {\n");
        ...
        {
            return this.Equals(input as PostHogPatchedOrganizationDomain);
        }

        /// <summary>
        /// Returns true if PostHogPatchedOrganizationDomain instances are equal
        /// </summary>
        /// <param name="input">Instance of PostHogPatchedOrganizationDomain to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostHogPatchedOrganizationDomain input)
        {
            if (input == null)
            {
                return false;
