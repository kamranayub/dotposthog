...
namespace DotPostHog.Model
{
    ...
    public partial class PostHogPatchedHook : IEquatable<PostHogPatchedHook>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostHogPatchedHook" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="varEvent">varEvent.</param>
        /// <param name="target">target.</param>
        /// <param name="resourceId">resourceId.</param>
        public PostHogPatchedHook(string id = default(string), string varEvent = default(string), string target = default(string), int? resourceId = default(int?))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostHogPatchedHook {\n");
        ...
        {
            return this.Equals(input as PostHogPatchedHook);
        }

        /// <summary>
        /// Returns true if PostHogPatchedHook instances are equal
        /// </summary>
        /// <param name="input">Instance of PostHogPatchedHook to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostHogPatchedHook input)
        {
            if (input == null)
            {
                return false;
