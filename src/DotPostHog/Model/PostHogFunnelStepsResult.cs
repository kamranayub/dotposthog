...
{
    /// <summary>
    /// PostHogFunnelStepsResult
    /// </summary>
    [DataContract(Name = "FunnelStepsResult")]
    public partial class PostHogFunnelStepsResult : IEquatable<PostHogFunnelStepsResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostHogFunnelStepsResult" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostHogFunnelStepsResult() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostHogFunnelStepsResult" /> class.
        /// </summary>
        ...
        public PostHogFunnelStepsResult(int count = default(int), string actionId = default(string), double averageConversionTime = default(double), double medianConversionTime = default(double), string convertedPeopleUrl = default(string), string droppedPeopleUrl = default(string), string order = default(string))
        {
            this.Count = count;
            // to ensure "actionId" is required (not null)
            if (actionId == null)
            {
                throw new ArgumentNullException("actionId is a required property for PostHogFunnelStepsResult and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("convertedPeopleUrl is a required property for PostHogFunnelStepsResult and cannot be null");
            }
            this.ConvertedPeopleUrl = convertedPeopleUrl;
            // to ensure "droppedPeopleUrl" is required (not null)
            if (droppedPeopleUrl == null)
            {
                throw new ArgumentNullException("droppedPeopleUrl is a required property for PostHogFunnelStepsResult and cannot be null");
            }
            this.DroppedPeopleUrl = droppedPeopleUrl;
            // to ensure "order" is required (not null)
            if (order == null)
            {
                throw new ArgumentNullException("order is a required property for PostHogFunnelStepsResult and cannot be null");
            }
            this.Order = order;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostHogFunnelStepsResult {\n");
        ...
        {
            return this.Equals(input as PostHogFunnelStepsResult);
        }

        /// <summary>
        /// Returns true if PostHogFunnelStepsResult instances are equal
        /// </summary>
        /// <param name="input">Instance of PostHogFunnelStepsResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostHogFunnelStepsResult input)
        {
            if (input == null)
            {
                return false;
