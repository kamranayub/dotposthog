...
namespace DotPostHog.Model
{
    ...
    public partial class BatchExportDestination : IEquatable<BatchExportDestination>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BatchExportDestination" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BatchExportDestination() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BatchExportDestination" /> class.
        /// </summary>
        ...
        public BatchExportDestination(TypeEnum type = default(TypeEnum), Dictionary<string, Object> config = default(Dictionary<string, Object>))
        {
            this.Type = type;
            this.Config = config;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BatchExportDestination {\n");
        ...
        {
            return this.Equals(input as BatchExportDestination);
        }

        /// <summary>
        /// Returns true if BatchExportDestination instances are equal
        /// </summary>
        /// <param name="input">Instance of BatchExportDestination to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BatchExportDestination input)
        {
            if (input == null)
            {
                return false;
