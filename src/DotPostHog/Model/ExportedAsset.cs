...
namespace DotPostHog.Model
{
    ...
    public partial class ExportedAsset : IEquatable<ExportedAsset>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ExportedAsset" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ExportedAsset() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ExportedAsset" /> class.
        /// </summary>
        ...
        public ExportedAsset(int? dashboard = default(int?), int? insight = default(int?), ExportFormatEnum exportFormat = default(ExportFormatEnum), Dictionary<string, Object> exportContext = default(Dictionary<string, Object>), DateTime? expiresAfter = default(DateTime?))
        {
        ...
        {
            return this.Equals(input as ExportedAsset);
        }

        /// <summary>
        /// Returns true if ExportedAsset instances are equal
        /// </summary>
        /// <param name="input">Instance of ExportedAsset to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExportedAsset input)
        {
            if (input == null)
            {
                return false;
