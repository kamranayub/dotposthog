...
namespace DotPostHog.Model
{
    ...
    public partial class FilterAction : IEquatable<FilterAction>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FilterAction" /> class.
        /// </summary>
        ...
        public FilterAction(string id = default(string), List<Property> properties = default(List<Property>), MathEnum? math = MathEnum.Total)
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for FilterAction and cannot be null");
            }
            this.Id = id;
        ...
        {
            return this.Equals(input as FilterAction);
        }

        /// <summary>
        /// Returns true if FilterAction instances are equal
        /// </summary>
        /// <param name="input">Instance of FilterAction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FilterAction input)
        {
            if (input == null)
            {
                return false;
