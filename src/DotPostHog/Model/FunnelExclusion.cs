...
namespace DotPostHog.Model
{
    ...
    public partial class FunnelExclusion : IEquatable<FunnelExclusion>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FunnelExclusion" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FunnelExclusion() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FunnelExclusion" /> class.
        /// </summary>
        ...
        public FunnelExclusion(string id = default(string), Property properties = default(Property), int funnelFromStep = 0, int funnelToStep = 1)
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for FunnelExclusion and cannot be null");
            }
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FunnelExclusion {\n");
        ...
        {
            return this.Equals(input as FunnelExclusion);
        }

        /// <summary>
        /// Returns true if FunnelExclusion instances are equal
        /// </summary>
        /// <param name="input">Instance of FunnelExclusion to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FunnelExclusion input)
        {
            if (input == null)
            {
                return false;
