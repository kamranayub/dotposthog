...
namespace DotPostHog.Model
{
    ...
    public partial class PatchedSessionRecordingPlaylist : IEquatable<PatchedSessionRecordingPlaylist>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PatchedSessionRecordingPlaylist" /> class.
        /// </summary>
        ...
        public PatchedSessionRecordingPlaylist(string name = default(string), string derivedName = default(string), string description = default(string), bool pinned = default(bool), bool deleted = default(bool), Dictionary<string, Object> filters = default(Dictionary<string, Object>))
        {
            this.Name = name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PatchedSessionRecordingPlaylist {\n");
        ...
        {
            return this.Equals(input as PatchedSessionRecordingPlaylist);
        }

        /// <summary>
        /// Returns true if PatchedSessionRecordingPlaylist instances are equal
        /// </summary>
        /// <param name="input">Instance of PatchedSessionRecordingPlaylist to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PatchedSessionRecordingPlaylist input)
        {
            if (input == null)
            {
                return false;
