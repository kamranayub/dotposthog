...
namespace DotPostHog.Model
{
    ...
    public partial class SurveySerializerCreateUpdateOnly : IEquatable<SurveySerializerCreateUpdateOnly>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SurveySerializerCreateUpdateOnly" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SurveySerializerCreateUpdateOnly() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SurveySerializerCreateUpdateOnly" /> class.
        /// </summary>
        ...
        public SurveySerializerCreateUpdateOnly(string name = default(string), string description = default(string), TypeEnum type = default(TypeEnum), int? linkedFlagId = default(int?), int targetingFlagId = default(int), Dictionary<string, Object> targetingFlagFilters = default(Dictionary<string, Object>), bool? removeTargetingFlag = default(bool?), Dictionary<string, Object> questions = default(Dictionary<string, Object>), Dictionary<string, Object> conditions = default(Dictionary<string, Object>), Dictionary<string, Object> appearance = default(Dictionary<string, Object>), DateTime? startDate = default(DateTime?), DateTime? endDate = default(DateTime?), bool archived = default(bool))
        {
            ...
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for SurveySerializerCreateUpdateOnly and cannot be null");
            }
            this.Name = name;
            this.Type = type;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SurveySerializerCreateUpdateOnly {\n");
        ...
        {
            return this.Equals(input as SurveySerializerCreateUpdateOnly);
        }

        /// <summary>
        /// Returns true if SurveySerializerCreateUpdateOnly instances are equal
        /// </summary>
        /// <param name="input">Instance of SurveySerializerCreateUpdateOnly to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SurveySerializerCreateUpdateOnly input)
        {
            if (input == null)
            {
                return false;
