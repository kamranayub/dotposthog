...
{
    /// <summary>
    /// PostHogPatchedGroupType
    /// </summary>
    [DataContract(Name = "PatchedGroupType")]
    public partial class PostHogPatchedGroupType : IEquatable<PostHogPatchedGroupType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostHogPatchedGroupType" /> class.
        /// </summary>
        /// <param name="nameSingular">nameSingular.</param>
        /// <param name="namePlural">namePlural.</param>
        public PostHogPatchedGroupType(string nameSingular = default(string), string namePlural = default(string))
        {
        ...
        /// </summary>
        [DataMember(Name = "group_type_index", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostHogPatchedGroupType {\n");
        ...
        {
            return this.Equals(input as PostHogPatchedGroupType);
        }

        /// <summary>
        /// Returns true if PostHogPatchedGroupType instances are equal
        /// </summary>
        /// <param name="input">Instance of PostHogPatchedGroupType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostHogPatchedGroupType input)
        {
            if (input == null)
            {
                return false;
