...
namespace DotPostHog.Model
{
    ...
    public partial class Group : IEquatable<Group>, IValidatableObject
    {
        ...
        public Group(int groupTypeIndex = default(int), string groupKey = default(string), Dictionary<string, Object> groupProperties = default(Dictionary<string, Object>))
        {
            this.GroupTypeIndex = groupTypeIndex;
            // to ensure "groupKey" is required (not null)
            if (groupKey == null)
            {
                throw new ArgumentNullException("groupKey is a required property for Group and cannot be null");
            }
