...
namespace DotPostHog.Model
{
    ...
    public partial class PostHogActivityLog : IEquatable<PostHogActivityLog>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostHogActivityLog" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostHogActivityLog() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostHogActivityLog" /> class.
        /// </summary>
        ...
        public PostHogActivityLog(PostHogUserBasic user = default(PostHogUserBasic), Guid? organizationId = default(Guid?), bool? isSystem = default(bool?), string activity = default(string), string itemId = default(string), string scope = default(string), Dictionary<string, Object> detail = default(Dictionary<string, Object>), DateTime createdAt = default(DateTime))
        {
            // to ensure "user" is required (not null)
            if (user == null)
            {
                throw new ArgumentNullException("user is a required property for PostHogActivityLog and cannot be null");
            }
            this.User = user;
            // to ensure "activity" is required (not null)
            if (activity == null)
            {
                throw new ArgumentNullException("activity is a required property for PostHogActivityLog and cannot be null");
            }
            this.Activity = activity;
            // to ensure "scope" is required (not null)
            if (scope == null)
            {
                throw new ArgumentNullException("scope is a required property for PostHogActivityLog and cannot be null");
            }
            this.Scope = scope;
        ...
        public PostHogUserBasic User { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostHogActivityLog {\n");
        ...
        {
            return this.Equals(input as PostHogActivityLog);
        }

        /// <summary>
        /// Returns true if PostHogActivityLog instances are equal
        /// </summary>
        /// <param name="input">Instance of PostHogActivityLog to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostHogActivityLog input)
        {
            if (input == null)
            {
                return false;
