...
namespace DotPostHog.Model
{
    ...
    public partial class PatchedTable : IEquatable<PatchedTable>, IValidatableObject
    {
        /// <summary>
        /// Defines Format
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PatchedTable" /> class.
        /// </summary>
        ...
        public PatchedTable(bool? deleted = default(bool?), string name = default(string), FormatEnum? format = default(FormatEnum?), string urlPattern = default(string), Credential credential = default(Credential))
        {
        ...
        {
            return this.Equals(input as PatchedTable);
        }

        /// <summary>
        /// Returns true if PatchedTable instances are equal
        /// </summary>
        /// <param name="input">Instance of PatchedTable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PatchedTable input)
        {
            if (input == null)
            {
                return false;
