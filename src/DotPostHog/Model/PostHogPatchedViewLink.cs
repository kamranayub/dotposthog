...
{
    /// <summary>
    /// PostHogPatchedViewLink
    /// </summary>
    [DataContract(Name = "PatchedViewLink")]
    public partial class PostHogPatchedViewLink : IEquatable<PostHogPatchedViewLink>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostHogPatchedViewLink" /> class.
        /// </summary>
        /// <param name="deleted">deleted.</param>
        /// <param name="table">table.</param>
        /// <param name="savedQueryId">savedQueryId.</param>
        /// <param name="toJoinKey">toJoinKey.</param>
        /// <param name="fromJoinKey">fromJoinKey.</param>
        public PostHogPatchedViewLink(bool? deleted = default(bool?), string table = default(string), Guid savedQueryId = default(Guid), string toJoinKey = default(string), string fromJoinKey = default(string))
        {
        ...
        /// </summary>
        [DataMember(Name = "saved_query_id", EmitDefaultValue = false)]
        public Guid SavedQueryId { get; set; }

        /// <summary>
        /// Gets or Sets SavedQuery
        /// </summary>
        [DataMember(Name = "saved_query", EmitDefaultValue = false)]
        ...
        /// </summary>
        [DataMember(Name = "to_join_key", EmitDefaultValue = false)]
        public string ToJoinKey { get; set; }

        /// <summary>
        /// Gets or Sets FromJoinKey
        /// </summary>
        [DataMember(Name = "from_join_key", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostHogPatchedViewLink {\n");
        ...
        {
            return this.Equals(input as PostHogPatchedViewLink);
        }

        /// <summary>
        /// Returns true if PostHogPatchedViewLink instances are equal
        /// </summary>
        /// <param name="input">Instance of PostHogPatchedViewLink to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostHogPatchedViewLink input)
        {
            if (input == null)
            {
                return false;
