...
namespace DotPostHog.Model
{
    ...
    public partial class PostHogProperty : IEquatable<PostHogProperty>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostHogProperty" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostHogProperty() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostHogProperty" /> class.
        /// </summary>
        ...
        public PostHogProperty(TypeEnum? type = TypeEnum.AND, List<PostHogPropertyItem> values = default(List<PostHogPropertyItem>))
        {
            // to ensure "values" is required (not null)
            if (values == null)
            {
                throw new ArgumentNullException("values is a required property for PostHogProperty and cannot be null");
            }
            this.Values = values;
            this.Type = type;
        }
        ...
        public List<PostHogPropertyItem> Values { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostHogProperty {\n");
        ...
        {
            return this.Equals(input as PostHogProperty);
        }

        /// <summary>
        /// Returns true if PostHogProperty instances are equal
        /// </summary>
        /// <param name="input">Instance of PostHogProperty to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostHogProperty input)
        {
            if (input == null)
            {
                return false;
