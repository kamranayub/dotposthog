...
namespace DotPostHog.Model
{
    ...
    public partial class GenericInsights : IEquatable<GenericInsights>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GenericInsights" /> class.
        /// </summary>
        ...
        public GenericInsights(List<FilterEvent> events = default(List<FilterEvent>), List<FilterAction> actions = default(List<FilterAction>), Property properties = default(Property), bool filterTestAccounts = false, string dateFrom = @"-7d", string dateTo = @"-7d")
        {
            this.Events = events;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GenericInsights {\n");
        ...
        {
            return this.Equals(input as GenericInsights);
        }

        /// <summary>
        /// Returns true if GenericInsights instances are equal
        /// </summary>
        /// <param name="input">Instance of GenericInsights to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GenericInsights input)
        {
            if (input == null)
            {
                return false;
