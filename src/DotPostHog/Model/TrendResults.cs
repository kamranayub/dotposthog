...
namespace DotPostHog.Model
{
    ...
    public partial class TrendResults : IEquatable<TrendResults>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TrendResults" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TrendResults() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TrendResults" /> class.
        /// </summary>
        ...
        public TrendResults(bool isCached = default(bool), DateTime lastRefresh = default(DateTime), TimezoneEnum? timezone = TimezoneEnum.UTC, List<TrendResult> result = default(List<TrendResult>))
        {
            ...
            if (result == null)
            {
                throw new ArgumentNullException("result is a required property for TrendResults and cannot be null");
            }
            this.Result = result;
        ...
        public List<TrendResult> Result { get; set; }
        ...
        {
            return this.Equals(input as TrendResults);
        }

        /// <summary>
        /// Returns true if TrendResults instances are equal
        /// </summary>
        /// <param name="input">Instance of TrendResults to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrendResults input)
        {
            if (input == null)
            {
                return false;
